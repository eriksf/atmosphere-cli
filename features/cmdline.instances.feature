Feature: Manage and get information about my instances
  ...
  Scenario: Show all of my instances
    ...
    And the command output should contain:
        """
        +--------------------------------------+------------+--------+----------+----------------+----------+------------------+------------+
        | uuid                                 | name       | status | activity | ip_address     | size     | provider         | launched   |
        +--------------------------------------+------------+--------+----------+----------------+----------+------------------+------------+
        | 366c9960-0313-497c-9597-dac29fdd63a9 | BioLinux 8 | active |          | 129.114.104.57 | m1.small | Jetstream - TACC | 2018-03-26 |
        +--------------------------------------+------------+--------+----------+----------------+----------+------------------+------------+
        """
